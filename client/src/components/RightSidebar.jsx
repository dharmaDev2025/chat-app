...
const RightSidebar = () => {
  ...
  return selectedUser && (
    <div className={`bg-[#8185b2]/10 text-white w-full h-full relative overflow-y-auto ${selectedUser ? "max-md:hidden" : ""}`}>
      ...
      <button onClick={()=>logout()} className='absolute bottom-5 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-purple-600 to-violet-800 text-white border-none text-sm font-light py-2 px-20 rounded-full cursor-pointer'>
  Logout
</button>
